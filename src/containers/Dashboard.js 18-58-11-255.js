  ...
  useEffect(() => {
    let myInterval = setInterval(() => {
      ...
      if (minutes === 1 && seconds === 0) {
        swal(
          "Only 1 Minute Left, Please Submit or else Answers WONT BE SAVED "
        );
      }
        ...
        <div className="lame">
          <h3 align="left">
            ...
            <span style={{ fontSize: "20px" }}>
              {" "}
              {JSON.stringify(sessionStorage.getItem("checkname")).slice(1, -8)}
            </span>
          </h3>
          <h3 align="left">
            PID :{" "}
            <span style={{ fontSize: "20px" }}>
              {" "}
              {JSON.stringify(sessionStorage.getItem("checkname"))
                .slice(-7)
                .slice(0, -1)}
            </span>
          </h3>
